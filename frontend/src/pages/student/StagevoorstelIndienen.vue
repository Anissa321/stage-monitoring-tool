...
<template>
  <main class="page">
    ...
    <section class="page-header">
      ...
      <h1>Stagevoorstel indienen</h1>
      <p class="subtitle">Vul de gegevens van je stagebedrijf en opdracht in. De stagecommissie beoordeelt je voorstel binnen 5 werkdagen.</p>
    </section>
...
@media (max-width: 900px) {
  ...
  .page-header, .card, .actions, .error-msg, .succes-msg { margin-left: 20px; margin-right: 20px; }
