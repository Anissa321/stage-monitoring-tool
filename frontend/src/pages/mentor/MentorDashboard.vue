      ...
      <div class="student-grid">
        ...
        >
          ...
          <div class="card-actions">
            <button class="primary-btn" @click="router.push('/mentor/logboek')">Bekijk logboeken</button>
            <button class="secondary-btn">Evaluatie</button>
          </div>
        </article>

        <p v-if="!data?.studenten?.length" style="padding: 28px; color: #64748b;">
...
.primary-btn, .secondary-btn { border: 1px solid #e2e8f0; padding: 9px 15px; border-radius: 12px; font-weight: 600; cursor: pointer; }
.primary-btn { background: #991b1b; color: white; border-color: #991b1b; }
.secondary-btn { background: white; color: #334155; }
.primary-btn:hover, .secondary-btn:hover { background: #7f1d1d; color: white; border-color: #7f1d1d; }
