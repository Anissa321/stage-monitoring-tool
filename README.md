...
Deze webapplicatie is ontwikkeld als eindwerk voor de opleiding Toegepaste Informatica aan de Erasmushogeschool Brussel.

De **Stage Monitoring Tool** digitaliseert en centraliseert het volledige stageproces — van aanvraag tot eindevaluatie — voor studenten, docenten, mentoren, de stagecommissie en de administratie.
...
Fase 1: Student dient stagevoorstel in
        ↓
Fase 2: Stagecommissie beoordeelt
        (goedgekeurd / afgekeurd / aanpassingen vereist)
        ↓
